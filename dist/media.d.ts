import { AnyURI, Name, Onvif, ReferenceToken } from './onvif';
...
export declare class Media {
     ...
     * Receive profiles
     */
    getProfiles(): Promise<(Profile | MediaProfile)[]>;
     ...
     */
    getStreamUri(options?: GetStreamUriOptions): Promise<{
        uri: AnyURI;
     ...
     * @param profileToken
     */
    getSnapshotUri({ profileToken }?: GetSnapshotUriOptions): Promise<{
        uri: AnyURI;
    }>;
}
